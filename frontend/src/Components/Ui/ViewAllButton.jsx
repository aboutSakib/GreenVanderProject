...
export default function ViewAllButton({ to, classNames = "", ...rest }) {
  return (
    <div className="flex justify-center items-center">
      <Link
        to={to}
        className={`flex items-center justify-center space-x-3 px-4 py-2 rounded-full border border-gray-300 bg-white transition-colors hover:bg-green-700 hover:border-green-700 w-[20%] ${classNames}`}
        {...rest}
      >
